import { getCargoById, getFuncionarioByNome } from "../../../../api";

const ListFuncionariosByNome = async ({ params }: { params: { slug: string } }) => {
    const funcionarios = await getFuncionarioByNome(params.slug);
...
export default ListFuncionariosByNome;